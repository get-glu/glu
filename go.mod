module github.com/get-glu/glu

go 1.23.0

require (
	github.com/get-glu/glu/otel v0.0.0-00010101000000-000000000000
	github.com/get-glu/glu/ui v0.0.1-prerelease9
...
replace github.com/get-glu/glu/otel => ./otel
